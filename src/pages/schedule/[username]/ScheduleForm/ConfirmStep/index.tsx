...
const confirmFormSchema = z.object({
    name: z.string().min(3, {message: 'O nome informado é menor que o permitido!'}),
...
export function ConfirmStep() {
    ...
    return (
        <ConfirmForm as="form" onSubmit={handleSubmit(handleConfirmScheuling)}>
            <FormHeader>
            <Text>
                <CalendarBlank/>
            ...
            <label>
                ...
                <TextInput type="email" placeholder="ignitecall@example.com"  {...register('email')}></TextInput>
                {
            ...
            <label>
                ...
                <TextArea  {...register('observation')}></TextArea>
            </label>
